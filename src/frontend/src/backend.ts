...
import type { ExternalBlob as _ExternalBlob, Nft as _Nft, NftId as _NftId, Time as _Time, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getNFT(arg0: NftId): Promise<Nft | null> {
        if (this.processError) {
            try {
    ...
    async mintNFT(arg0: string, arg1: string, arg2: ExternalBlob): Promise<NftId> {
        if (this.processError) {
            try {
                const result = await this.actor.mintNFT(arg0, arg1, await to_candid_ExternalBlob_n17(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateNFT(arg0: NftId, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNFT(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Nft_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Nft): Promise<Nft> {
...
async function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Nft]): Promise<Nft | null> {
    return value.length === 0 ? null : await from_candid_Nft_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Nft>): Promise<Array<Nft>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Nft_n13(_uploadFile, _downloadFile, x)));
}
